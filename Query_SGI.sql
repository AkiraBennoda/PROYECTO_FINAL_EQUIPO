...
drop database `sgiu`;
CREATE DATABASE IF NOT EXISTS `sgiu` ;
USE `sgiu`;
...
CREATE TABLE IF NOT EXISTS `persona` (
  ...
  /*Alumno*/
	...
	calificacion DECIMAL  NULL /*CHECK( calificacion > 7.0)*/,
...
VALUES(1,0b1,"$2a$04$kOG68gUHNand1WmoyJ.z.e9fEEULSpwZV0nmBnLkWnt6E7MEi6lSi","admin");

INSERT INTO user (id,enabled,password,username) 
VALUES(2,0b1,"$2a$04$kOG68gUHNand1WmoyJ.z.e9fEEULSpwZV0nmBnLkWnt6E7MEi6lSi","user");
...
(
	idInscripcion BIGINT PRIMARY KEY  AUTO_INCREMENT, 
	fechaInscripcion INT  NOT NULL,
	reinscripcion INT  NULL,
	pagado INT  NOT NULL,
	...
	idFactura BIGINT  NOT NULL,
		...
		CONSTRAINT FK_Alumno FOREIGN KEY (idPersona)
   REFERENCES Persona(idPersona),
   
 		CONSTRAINT FK_Curso FOREIGN KEY (idCurso)
   REFERENCES Curso(idCurso),
 
		CONSTRAINT FK_TipoPagoC FOREIGN KEY (idTipoPago)
...
select * from persona;
select * from curso;
INSERT INTO inscripcion (fechaInscripcion, reinscripcion, pagado, idPersona, idCurso, idTipoPago, idFactura  ) VALUES (11091992, 1, 1, 7, 2, 1, 2);
