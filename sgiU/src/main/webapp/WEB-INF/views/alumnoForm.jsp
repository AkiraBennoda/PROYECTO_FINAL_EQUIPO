...
<spring:url value="/alumnos/alumnoForm" var="btnAlumnosForm" />
<spring:url value="/alumnos/listar" var="btnAlumnos" />
...
<body>
	...
	<div class="container-fluid">
		<div class="row">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item" aria-current="page"><a
							class="btn btn-outline-secondary mx-3" href="${btnAlumnos}"
							role="button"> <spring:message code="label.button.alumnos" />
						</a></li>
						<li class="breadcrumb-item active" aria-current="page"><a
							class="btn btn-outline-secondary mx-3" href="${btnAlumnosForm}"
							role="button"> <spring:message
									code="label.button.alumnos.agregar" />
						</a></li>
					</ol>
				</nav>
			</div>
			...
			<div class="col-md-12">
				<spring:url value="/alumnos/guardaAlumno" var="urlGuardar" />
				<spring:url value="/alumnos/listar" var="urlRegresar" />
				<form:form action="${urlGuardar}" cssClass="form-horizontal" method="post"
					...
					<div class="form-group row">
						<label for="matricula" class="col-md-1 col-form-label"> 
						<spring:message
								code="label.alumno.matricula" />
						</label>
						<div class="col-md-7">
					...
					<div class="form-group row">
						<label for="calificacion" class="col-md-1 col-form-label"> 
						<spring:message
								code="label.alumno.calificacion" />
						</label>
						<div class="col-md-7">
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<input class="btn btn-primary" type="submit"
						     ...
						     <a href="/sgi/alumnos/listar" class="btn btn-primary"
